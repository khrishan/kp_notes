...
# in sample.txt. We want the tavles from 2 to 12 (similar to the output 
# from the For loops part 2 lecture in section 6.
# 
# The first coumn of numbers should be right justified. As an example,
...
with open('sample.txt', 'a') as sample_file:
    for i in range (2, 13):
        for j in range (1, 13):
            print('{:2} times {:2} is {:4}'.format(j, i, i*j), file=sample_file)
