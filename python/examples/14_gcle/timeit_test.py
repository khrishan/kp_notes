import timeit #In order to use this function, you can either use a function or convert your code to a string?! So, we're doing that one
...
print('List Comprehension:\t{}'.format(result_2))
